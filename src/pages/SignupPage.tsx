...
import { Mail, Lock, User, ArrowRight, AlertCircle, Building2, Phone, MapPin } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await registerUser({
        ...
        companyType: formData.companyType as 'individual' | 'small_business' | 'enterprise',
